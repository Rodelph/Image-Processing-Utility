...
QT_MOC_LITERAL(6, 94, 25), // "on_spinBox_1_valueChanged"
QT_MOC_LITERAL(7, 120, 25), // "on_spinBox_2_valueChanged"
QT_MOC_LITERAL(8, 146, 25), // "on_spinBox_3_valueChanged"
QT_MOC_LITERAL(9, 172, 25), // "on_spinBox_4_valueChanged"
QT_MOC_LITERAL(10, 198, 25), // "on_spinBox_5_valueChanged"
QT_MOC_LITERAL(11, 224, 25), // "on_spinBox_6_valueChanged"
QT_MOC_LITERAL(12, 250, 25), // "on_spinBox_7_valueChanged"
QT_MOC_LITERAL(13, 276, 25), // "on_spinBox_8_valueChanged"
QT_MOC_LITERAL(14, 302, 25) // "on_spinBox_9_valueChanged"

    },
    "highpassfilt\0on_foldBtn_clicked\0\0"
    "on_retBtn_clicked\0on_transformBtn_clicked\0"
    "on_confBtn_clicked\0on_spinBox_1_valueChanged\0"
...
void highpassfilt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { int _r = _t->on_spinBox_1_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 5: { int _r = _t->on_spinBox_2_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 6: { int _r = _t->on_spinBox_3_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 7: { int _r = _t->on_spinBox_4_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 8: { int _r = _t->on_spinBox_5_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 9: { int _r = _t->on_spinBox_6_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 10: { int _r = _t->on_spinBox_7_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 11: { int _r = _t->on_spinBox_8_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 12: { int _r = _t->on_spinBox_9_valueChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
